...
class MyValuePicksDaoTestQuestion {
    ...
    fun 가치관Pick을_삽입하고_조회할_수_있다() = runTest {
        // given
        val valuePickQuestion = ValuePickQuestionEntity(
            id = 1,
            category = "음주",
    ...
    fun 이전_가치관Pick을_삭제하고_새로운_가치관Pick을_삽입할_수_있다() = runTest {
        // given
        val oldValuePickQuestion = ValuePickQuestionEntity(
            id = 1,
            category = "이전 카테고리",
            question = "이전 질문"
        )
        ...
        // when
        val newValuePickQuestion = ValuePickQuestionEntity(
            id = 2,
            category = "새로운 카테고리",
            question = "새로운 질문"
        )
